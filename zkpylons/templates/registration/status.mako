...
% if h.klf_info['conference_status'] == 'not_open':
      <b>Registrations</b> are <i>not</i> open<br><br>
% elif h.klf_info['conference_status'] == 'open' and c.ceilings['conference-paid'].available():
...
% if h.klf_info['conference_status'] == 'open' and c.ceilings['conference-earlybird'].available() and c.ceilings['conference-paid'].available():
...
% elif h.klf_info['conference_status'] == 'open' and c.ceilings['conference-paid'].available() and not c.ceilings['conference-earlybird'].available():
...
% if 'conference-paid' not in c.ceilings or (c.registration is None and h.klf_info['conference_status'] == 'not_open'):
    <h2>Registrations are not open</h2>
    <p>Registrations are not yet open. Please come back soon!</p>
% elif c.registration is None and h.klf_info['conference_status'] == 'closed':
