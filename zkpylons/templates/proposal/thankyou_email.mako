...
Subject: Confirmation of your ${ c.proposal.type.name.lower() } proposal for ${ h.klf_info['event_name'] }

Dear ${ c.person.firstname },

Thank you for proposing a ${ c.proposal.type.name.lower() } for ${ h.klf_info['event_name'] }.
...
You consent to ${ h.klf_info["event_parent_organisation"] } releasing both the video of your ${ c.proposal.type.name.lower() } and your slides, if you supply them to us, under the ${ h.klf_info["media_license_name"] }.
% else:
%   if c.proposal.video_release:
You consent to ${ h.klf_info["event_parent_organisation"] } releasing the video of your ${ c.proposal.type.name.lower() } under the ${ h.klf_info["media_license_name"] }.
%   else:
You DO NOT consent to ${ h.klf_info["event_parent_organisation"] } releasing the video of your ${ c.proposal.type.name.lower() }.
%   endif
%   if c.proposal.slides_release:
You consent to ${ h.klf_info["event_parent_organisation"] } releasing your slides, if you supply them to us, under the ${ h.klf_info["media_license_name"] }.
%   else:
You DO NOT consent to ${ h.klf_info["event_parent_organisation"] } releasing your slides.
%   endif
% endif
