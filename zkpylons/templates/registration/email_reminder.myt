...
Subject: Please review your <% h.klf_info['event_name'] %> registration details

Dear <% c.firstname %>,

This is a reminder of your <% h.klf_info['event_name'] %> registration.
...
anything, log into your account at:
  ...
  <% h.klf_info['event_url'] %>

If you have any problems, feel free to email <% h.klf_info['contact_email'] %>.

Regards,

The <% h.klf_info['event_name'] %> team
