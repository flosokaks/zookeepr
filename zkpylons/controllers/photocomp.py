...
from zkpylons.config import klf_info as klf_info
...
class PhotoCompEntry(object):
    ...
    def filename(self, scale):
        date_day = klf_info.klf_info['date'] + datetime.timedelta(self.day)
    ...
    def from_filename(cls, filename):
        ...
        open_date = klf_info.klf_info['date']
...
class PhotocompController(BaseController):
    ...
    def index(self):
        ...
        c.open_date =  klf_info.klf_info['date']
