...
% if h.klf_info['cfp_hide_assistance_options'] is 'no':
...
% if h.klf_info['cfp_hide_assistance_options'] is 'by_email': 
    <h2>Travel &amp; Accommodation Assistance</h2>
    ...
    <p class="note" style="margin-top: 0em">Travel &amp; accommodation assistance <em>may</em> be available in circumstances where it is absolutely necessary. To find out more please e-mail <em>${ h.klf_info['contact_email'] }</em>.</p>
% endif
    ...
    <p class="entries">
      ...
      <label for="proposal.video_release">I allow ${ h.klf_info["event_parent_organisation"] } to
      release any recordings of my presentations, tutorials and minconfs under the <a href="${ h.klf_info["media_license_url"] }">${ h.klf_info["media_license_name"] }</a></label>
    </p>

    <p class="entries">
      ${ h.checkbox('proposal.slides_release') }
      <label for="proposal.slides_release">I allow ${ h.klf_info["event_parent_organisation"] } to release any other material (such as slides) from my presentations, tutorials and minconfs under the <a href="${ h.klf_info["media_license_url"] }">${ h.klf_info["media_license_name"] }</a></label>
    </p>
