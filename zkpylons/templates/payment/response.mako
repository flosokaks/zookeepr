...
Subject: Rejected payment attempt for ${ h.klf_info['event_name'] }
...
%else:
Subject: Successful payment for ${ h.klf_info['event_name'] }
...
The ${ h.klf_info['event_name'] } Organising Committee
