...
Subject: Confirmation of your ${ c.funding.type.name } funding request for ${ h.klf_info['event_name'] }

Dear ${ c.person.firstname },

Thank you for submitting a ${ c.funding.type.name } requestfor ${ h.klf_info['event_name'] }.
