...
<%
    this_url = h.url_for()
    url=h.klf_info["event_permalink"] + this_url
%>
...
${ parent.toolbox_extra_reviewer() }
    ...
    <ul class="netv-vmenu">
    %if h.klf_info['cfp_hide_scores'] == 'no':
